...
type ModalContextType = (() => void) | null;
...
function Modal({ children, isOpen, onClose, width, closeOverlay = false, variant= 'dialog' }: ModalProps) {
...
Modal.Header = function Header({ className, children }: ModalSubComponentProps) {
  return <div className=' bg-primary text-white text-lg flex gap-2 z-[1002] md:p-4 rounded-t-2xl p-2 '>{children }</div>
};
